...
var InvestmentPage = function () {
    ...
    return (react_1["default"].createElement(react_1["default"].Fragment, null,
        ...
        react_1["default"].createElement("div", { id: "portfolioStructure" },
            react_1["default"].createElement(PortfolioStructure_1["default"], { ifPressed: firstBlockVisible, selectorValue: firstCurrentValue, idOption: firstBlockIdOption, onClickSelector: onClickFirstSelectController, emitCoords: onScrollPortfolioStructure, emitSelectorBottomLeft: getFirstControllerBottomLeft })),
        react_1["default"].createElement(CompositionReserves_1["default"], { ifPressed: secondBlockVisible, selectorValue: secondCurrentValue, idOption: secondBlockIdOption, onClickSelector: onClickSecondSelectController, emitCoords: onScrollCompositionReserves, emitSelectorBottomLeft: getSecondControllerBottomLeft }),
