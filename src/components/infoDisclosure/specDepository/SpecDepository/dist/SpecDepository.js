...
var SpecDepositoryItem_1 = require("../SpecDepositoryItem/SpecDepositoryItem");
    ...
    return (react_1["default"].createElement("article", null,
        react_1["default"].createElement("section", { className: SpecDepository_module_scss_1["default"]["spec-depository"] },
            react_1["default"].createElement("div", { className: SpecDepository_module_scss_1["default"]["spec-depository__container"] },
                ...
                react_1["default"].createElement("div", null, currentValue === "Contracts operating" ? (react_1["default"].createElement(SpecDepositoryItem_1["default"], { subheading: infoDisclosureData_1.depository1.subheading, title: infoDisclosureData_1.depository1.title, subtitle: infoDisclosureData_1.depository1.subtitle })) : (react_1["default"].createElement(SpecDepositoryItem_1["default"], { subheading: infoDisclosureData_1.depository2.subheading, title: infoDisclosureData_1.depository2.title, subtitle: infoDisclosureData_1.depository2.subtitle }))))),
