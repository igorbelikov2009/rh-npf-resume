...
var MainCarousel = function (_a) {
    ...
    return (react_1["default"].createElement("div", { className: MainCarousel_module_scss_1["default"]["carousel-tape"] }, carouselLinks &&
        carouselLinks.map(function (link, index) { return (react_1["default"].createElement(NewsLinkContainer_1["default"], { key: index, isClear: index === qq || jj === index, link: link, emitWidthColumn: getWidthColumn })); })));
};
