...
var BusinessProgramm = function () {
    return (react_1["default"].createElement("section", { className: BusinessProgramm_module_scss_1["default"]["business-programm"] },
        react_1["default"].createElement("div", { className: BusinessProgramm_module_scss_1["default"]["business-programm__container"] },
            ...
            react_1["default"].createElement("div", { className: BusinessProgramm_module_scss_1["default"]["business-programm__block"] }, businessPageData_1.businessCards &&
                businessPageData_1.businessCards.map(function (card, index) { return (react_1["default"].createElement("div", { key: index, className: BusinessProgramm_module_scss_1["default"]["card"] },
