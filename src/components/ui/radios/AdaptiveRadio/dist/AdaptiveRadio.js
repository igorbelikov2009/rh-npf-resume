...
var AdaptiveRadio = function (_a) {
    ...
    return (react_1["default"].createElement("div", { className: AdaptiveRadio_module_scss_1["default"]["adaptive-radio"] }, optionsItems.map(function (item) { return (react_1["default"].createElement(AdaptiveRadioItem_1["default"], { key: item.value, title: item.date, value: item.value, id: item.id, isActive: item.value === currentValue, emitValue: onChangeRadio })); })));
};
